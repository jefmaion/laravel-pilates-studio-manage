<div class="row">
    ...
    <x-adminlte-input name="user[name]" label="Nome" fgroup-class="col-9 col-lg-9 col-md-6 col-sm-12" enable-old-support value="{{ $user->name }}"  />
    ...
    <x-adminlte-input name="user[birth_date]" label="Data de Nasc." type="date"  fgroup-class="col-12 col-md-3 col-sm-6" enable-old-support value="{{ $user->birth_date }}"  />
    <x-adminlte-input name="user[cpf]" label="CPF" fgroup-class="col-12 col-lg-3 col-md-3 col-sm-6" enable-old-support value="{{ $user->cpf }}" />
    ...
    <x-adminlte-input name="user[phone]" label="Telefone (WhatsApp)" fgroup-class="col-12 col-lg-4 col-md-3 col-sm-6" enable-old-support value="{{ $user->phone }}"  />
    <x-adminlte-input name="user[phone2]" label="Telefone Recado" fgroup-class="col-12 col-lg-4 col-md-3 col-sm-6" enable-old-support value="{{ $user->phone2 }}" />
    <x-adminlte-input name="user[email]" label="Email" fgroup-class="col-12 col-lg-4 col-md-12 col-sm-12" enable-old-support value="{{ $user->email }}" />
    ...
    <x-adminlte-input name="user[address]" label="Endereço" fgroup-class="col-12 col-lg-8 col-sm-7" enable-old-support value="{{ $user->address }}" />
    <x-adminlte-input name="user[number]" label="Nº" fgroup-class="col-12 col-lg-2 col-sm-2" enable-old-support value="{{ $user->number }}" />
    <x-adminlte-input name="user[complement]" label="Complemento" fgroup-class="col-12 col-lg-3 col-sm-6" enable-old-support value="{{ $user->complement }}" />
