...
<div class="row">
    <div class="col-12">
        <x-adminlte-card theme="purple" tsheme-mode="outline">
            <h1 class="font-weight-light m-0 text-purple">{{ $student->user->name }}</h1>
            <div class="text-muted">
                <div>{{ $student->user->age }} anos / {{ $student->user->genderName }}</div>
...
<div class="card card-purple card-outline card-outline-tabs">
    <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active text-dark" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">
                   <i class="fas fa-book-open    "></i>
                    Matrículas
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  text-dark" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">
                    <i class="fa fa-calendar" aria-hidden="true"></i>
                    Aulas
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link   text-dark" id="custom-tabs-four-settings-tab" data-toggle="pill" href="#custom-tabs-four-settings" role="tab" aria-controls="custom-tabs-four-settings" aria-selected="false">
