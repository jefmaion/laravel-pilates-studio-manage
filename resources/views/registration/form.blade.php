...
<div class="row">
    ...
    <x-adminlte-select2 name="student_id" id="student_id" label="Aluno" fgroup-class="col-12 col-lg-8 col-md-3 col-sm-6" empty-option="Select an option..." > 
        <option value=""></option>
    ...
    <x-adminlte-select2 name="status" id="status" label="Status da Matrícula" fgroup-class="col-12 col-lg-2 col-md-3 col-sm-6" empty-option="Select an option..." > 
        <option value=""></option>
        <x-adminlte-options :options="['A' => 'Ativo', 'C' => 'Cancelada']" :selected="$registration->status"  />
    </x-adminlte-select2>
    ...
    <x-adminlte-input name="final_value" id="final_value" label="Valor Final" fgroup-class="col-12 col-lg-1 col-md-3 col-sm-6" enable-old-support value="{{ $registration->final_value }}" />

        <x-adminlte-select2 name="payment_type_id" id="payment_id" label="Forma" fgroup-class="col-12 col-lg-2 col-md-3 col-sm-6" empty-option="Select an option..." > 
            <option value=""></option>
